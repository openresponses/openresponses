...
/**
 * @description A streaming event that indicated a web search tool call was in progress.
 */
export const responseWebSearchCallInProgressStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated a web search tool call was in progress.",
  );
