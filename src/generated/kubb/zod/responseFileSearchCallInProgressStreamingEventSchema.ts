...
/**
 * @description A streaming event that indicated a file search tool call was in progress.
 */
export const responseFileSearchCallInProgressStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated a file search tool call was in progress.",
  );
