...
/**
 * @description A streaming event that indicated a file search tool call was completed.
 */
export const responseFileSearchCallCompletedStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated a file search tool call was completed.",
  );
